...
import { COL, drawHeadingGhost, drawHeadingMark, drawResultFrame, headingEnglish } from '../draw/resultCanvasKit';
...
export async function generateLeagueResultDataUrl(
  ...
  // 表の外枠を後から重ね描きして綺麗にする
  drawResultFrame(ctx, tableX, tableY, tableW, tableH, 12);
