      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-gray-50 p-4">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-red-200 overflow-hidden">
          ...
          <div className="p-5 space-y-4">
            ...
            {this.state.error && (
              <pre className="text-[10px] text-gray-500 bg-gray-50 border border-gray-200 rounded-lg p-3 overflow-auto max-h-32 whitespace-pre-wrap break-words">
            ...
            <div className="flex gap-2.5">
              <button
                ...
                className="flex-1 py-2.5 text-sm font-semibold text-gray-600 bg-gray-100 border border-gray-200 rounded-xl hover:bg-gray-200 transition-all"
              >
                閉じて続ける
              </button>
              <button
                onClick={this.handleReload}
                className="flex-1 py-2.5 text-sm font-bold text-white rounded-xl bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 shadow-sm transition-all"
              >
                再読み込み
              </button>
            </div>
